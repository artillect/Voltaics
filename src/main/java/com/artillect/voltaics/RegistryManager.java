...
import com.artillect.voltaics.block.BlockDuranizedCopperOre;
import com.artillect.voltaics.block.BlockEuraliteOre;
...
public class RegistryManager {
	...
	public static Block voltaicPile, lowVoltageConduit, inductor, copperOre, duranizedCopperOre, euraliteOre;
	...
	public static void registerAll(){
		...
		blocks.add(copperOre = (new BlockCopperOre("copperOre")).setIsFullCube(true).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.4f));
		blocks.add(duranizedCopperOre = (new BlockDuranizedCopperOre("duranizedCopperOre")).setIsFullCube(true).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.4f));
		blocks.add(euraliteOre = (new BlockEuraliteOre("euraliteOre")).setIsFullCube(true).setIsOpaqueCube(false).setHarvestProperties("pickaxe", 0).setHardness(1.4f));
	...
	public static void initR(){
		GameRegistry.addSmelting(copperOre, new ItemStack(ingotCopper), 0.7f);
		GameRegistry.addSmelting(duranizedCopperOre, new ItemStack(ingotCopper, 2), 0.7f);
		GameRegistry.addSmelting(euraliteOre, new ItemStack(ingotCopper, 16), 0.7f);
	}
