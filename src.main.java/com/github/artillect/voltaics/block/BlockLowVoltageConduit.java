...
public class BlockLowVoltageConduit extends BlockTEBase implements IModeledBlock{
    ...
    /* public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos, EnumFacing facing) {
        ...
        return (te instanceof TileEntityLowVoltageConduit) || (te.hasCapability(Capabilities.CAPABILITY_SOURCE, facing.getOpposite()) || (te.hasCapability(Capabilities.CAPABILITY_SINK, facing.getOpposite())));
    } */
